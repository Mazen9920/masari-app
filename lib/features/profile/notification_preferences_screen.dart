          ...
          children: [
            ...
            _buildCard([
              ...
              _buildToggleRow(
                ...
                title: l10n.notificationsDeliveries,
                subtitle: l10n.notificationsDeliveriesSubtitle,
                value: settings.deliveryAlerts,
                onChanged: (v) => notifier.setDeliveries(v),
              ),
              _divider(),
              _buildToggleRow(
                icon: Icons.insights_rounded,
                iconColor: const Color(0xFF14B8A6),
                title: l10n.notificationsInsights,
                subtitle: l10n.notificationsInsightsSubtitle,
                value: settings.insightAlerts,
                onChanged: (v) => notifier.setInsights(v),
              ),
              _divider(),
              _buildToggleRow(
                icon: Icons.fact_check_outlined,
                iconColor: const Color(0xFF64748B),
                title: l10n.notificationsDataIntegrity,
                subtitle: l10n.notificationsDataIntegritySubtitle,
                value: settings.dataIntegrityAlerts,
                onChanged: (v) => notifier.setDataIntegrity(v),
              ),
            ]),
            const SizedBox(height: 24),
