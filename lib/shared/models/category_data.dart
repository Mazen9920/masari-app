...
class CategoryData {
  ...
  static const _financingIds = {
    ...
    'cat_salary_payment', 'cat_asset_sale',
  };
  ...
  static const List<CategoryData> all = [
    ...
    CategoryData(
      id: 'cat_accrued_payment',
      userId: 'system',
      name: 'Accrued Payment',
      iconName: 'payments',
      colorValue: 0xFF64748B,
      bgColorValue: 0xFFF8FAFC,
      isExpense: false,
    ),
    CategoryData(
      id: 'cat_gateway_fees',
  ...
  String localizedName(AppLocalizations l10n) {
    switch (id) {
      ...
      case 'cat_shipping_expense': return l10n.categoryShippingExpense;
      case 'cat_manufacturing_cost': return l10n.categoryManufacturingCost;
      case 'cat_bosta_cashout': return 'Bosta Cashout';
      ...
      case 'cat_employee_advance': return l10n.categoryEmployeeAdvance;
      default: return name;
    }
  }
}
...
extension CategoryDataUIExt on CategoryData {
  ...
  static String iconNameFromData(IconData icon) {
    ...
    if (icon == Icons.people_rounded) return 'people';
    if (icon == Icons.payments_rounded) return 'payments';
    return 'grid_view';
  }
}
...
extension CategoryDataL10n on CategoryData {
  String localizedName(AppLocalizations l10n) {
    ...
    switch (id) {
      ...
      case 'cat_manufacturing_cost': return l10n.catManufacturingCost;
      ...
      case 'cat_employee_advance': return l10n.catEmployeeAdvance;
      default: return name;
    }
  }
}
